...
def zero_funct(par):
    pass
class Game(metaclass=Game_meta):
    def __init__(self,warrirors_list,traders_list,monster_list,civilians_list,location,player:Player,location_type):
    ...
    def get_list_of_choose(self):
        ...
        if self.whant_to_use_elexir:
            ...
            self.list_of_choose=[[Message("піти вліво",Game.go_left),Message("піти вправо",Game.go_right), Message("випити еліксир",Game.whant_to_use_elexir),Message("змінити зброю",Game.whant_to_change_weapon)],self.curent_bot.get_list_of_choose() if self.curent_bot else []]
    ...
    def get_user_info(self):
        ...
        return ["гравець","здоровя :"+str(self.player.health), "гроші: "+ str(self.player.money),"наявний еліксир: "+elexir_str[:len(elexir_str)-1],"зброя в запасі: "+weapon_str[:len(weapon_str)-1],"вибрана зброя: "+ current_weapon_name]
